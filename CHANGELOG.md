...
## [0.25.0](https://github.com/open-constructs/cdk-terrain/compare/v0.24.0...v0.25.0) (2026-09-24)
...
* **gha:** Revert "run the affected unit tests against OpenTofu ([#439](https://github.com/open-constructs/cdk-terrain/issues/439))" ([#446](https://github.com/open-constructs/cdk-terrain/issues/446)) ([ae015ef](https://github.com/open-constructs/cdk-terrain/commit/ae015ef2b7ba781ea28516f0c29ead2827e225ff))
* **gha:** run the affected unit tests against OpenTofu ([#439](https://github.com/open-constructs/cdk-terrain/issues/439)) ([823682d](https://github.com/open-constructs/cdk-terrain/commit/823682df87027d4c52776a93f23d3eb2ff8f734b))
...
* **lib:** add asset staging core with no bundling ([#433](https://github.com/open-constructs/cdk-terrain/issues/433)) ([44d8bd1](https://github.com/open-constructs/cdk-terrain/commit/44d8bd1113b9c4918b6e0f57520c7b8e8f9f92dc))
...
* **deps:** move jsii-rosetta to 6.0.16 for stream-json 3 ([#463](https://github.com/open-constructs/cdk-terrain/issues/463)) ([f1ec16f](https://github.com/open-constructs/cdk-terrain/commit/f1ec16f2be92d518c513ade6813985bd71628767))
...
* **provider-generator:** pick the docs registry from targetVersions ([#443](https://github.com/open-constructs/cdk-terrain/issues/443)) ([00f2884](https://github.com/open-constructs/cdk-terrain/commit/00f288457839f2c3ddf40080b33004980af96c6d))
...
* **tests:** mark the terraform-cloud target Terraform-only in the matrix ([#430](https://github.com/open-constructs/cdk-terrain/issues/430)) ([b0deefa](https://github.com/open-constructs/cdk-terrain/commit/b0deefa874d5585f6c0ed140d7e8ab519155f05c))
...
* **lib:** Remove the ValidateBinaryVersion synth-time binary probe ([#457](https://github.com/open-constructs/cdk-terrain/issues/457)) ([e60142e](https://github.com/open-constructs/cdk-terrain/commit/e60142e4d355b917310d6ac84f1f9b086a56437a))
* **lib:** Use declared targetVersions for synth-time validation of import blocks ([#454](https://github.com/open-constructs/cdk-terrain/issues/454)) ([c0097f4](https://github.com/open-constructs/cdk-terrain/commit/c0097f4812a58fd8671d2e65e3b72abbf5a45fdd))
* **lib:** Use declared targetVersions for synth-time validation of resource moves ([#453](https://github.com/open-constructs/cdk-terrain/issues/453)) ([43edc1e](https://github.com/open-constructs/cdk-terrain/commit/43edc1ef8238332fa428cd1ca24a06b3d79e8a32))
* **lib:** Use declared targetVersions for synth-time validation of terraform_data ([#455](https://github.com/open-constructs/cdk-terrain/issues/455)) ([a1c125b](https://github.com/open-constructs/cdk-terrain/commit/a1c125bb39c27e1aebecad87023c4aa237bdbf49))
* **lib:** Use declared targetVersions for synth-time validation of the cloud backend ([#456](https://github.com/open-constructs/cdk-terrain/issues/456)) ([4a83507](https://github.com/open-constructs/cdk-terrain/commit/4a83507815da6d021cd5a262533250e65fa9fc8f))
...
* **gha:** select the CLI by binary name instead of concatenating a version ([#438](https://github.com/open-constructs/cdk-terrain/issues/438)) ([914da56](https://github.com/open-constructs/cdk-terrain/commit/914da565a0bf580004d72f17853603ae60e2056a))
...
* **tests:** add timeout handling to spawned commands ([#432](https://github.com/open-constructs/cdk-terrain/issues/432)) ([ddb4a8a](https://github.com/open-constructs/cdk-terrain/commit/ddb4a8a06f0c9f151c174a6dae9ceeab6fc51047))
* **tests:** run the function-binding scripts with tsx ([#431](https://github.com/open-constructs/cdk-terrain/issues/431)) ([fec67bf](https://github.com/open-constructs/cdk-terrain/commit/fec67bf379aec3384bb9aae867729356336de2af))


### Tests

* **lib:** ensure TerraformAsset stage within stack own directory ([#434](https://github.com/open-constructs/cdk-terrain/issues/434)) ([9a80366](https://github.com/open-constructs/cdk-terrain/commit/9a80366041d4ce6dd940b6ff0c05b7d8e26b6639))
* **lib:** move matcher Docker fixture to a provider version OpenTofu accepts ([#429](https://github.com/open-constructs/cdk-terrain/issues/429)) ([7b0da12](https://github.com/open-constructs/cdk-terrain/commit/7b0da12366f77f37123b137384f57d42795d9553))
* **tests:** move the python providers fixture to Docker provider 3.9.0 ([#440](https://github.com/open-constructs/cdk-terrain/issues/440)) ([a678473](https://github.com/open-constructs/cdk-terrain/commit/a6784733f5bdff6a00b3583a03328f4cf870dc27))
* **tests:** move the testing-matchers fixtures to Docker provider 3.x ([#436](https://github.com/open-constructs/cdk-terrain/issues/436)) ([8e2c60e](https://github.com/open-constructs/cdk-terrain/commit/8e2c60e274ab71789a3e53ffcb6c92041d48598b))
